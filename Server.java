...
public class Server {
    ...
    //TURNOS ANCIÕES
    //NÃO MEXER OU ARRISCA ENFURECER AOS DEUSES ANTIGOS
...
class Cliente implements Runnable {
    ...
    volatile int acao = 0; // A�ao escolhida
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                if (turno == 0) { // S� considera o primeiro ataque enviado
                ...
                for (Cliente cl : room) {
                    if (cl.s != this.s) {
                        ...
                        // Verifica se � pra trocar de pokemon
...
class Room implements Runnable {
    ...
    public void run() {
        ...
        while (placebo == 1) {
            ...
            if ((client1.turno == 2) && (client2.turno == 2)) { // A��es do turno kk
                // Executar acao//
                // Cliente 1
                if (client1.acao != 0) {
